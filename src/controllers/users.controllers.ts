...
export const listCarByUserIdController = async (req: Request, res: Response): Promise<Response> => {
  ...
  const carList = await listCarByUserIdService(req.params.userUUID, req.user.uuid, page);
...
export const sendEmailController = async (req: Request, res: Response): Promise<Response> => {
