...
export class FirstMigration1688064894900 implements MigrationInterface {
    name = 'FirstMigration1688064894900'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(80) NOT NULL, "email" character varying(255) NOT NULL, "password" character varying(120) NOT NULL, "cpf" character varying(11) NOT NULL, "celphone" character varying(11) NOT NULL, "birthday" date, "description" text, "imageUrl" text, "is_seller" boolean, "reset_password" character varying, "addressUuid" uuid, CONSTRAINT "REL_8330768f6823a913e0293952c8" UNIQUE ("addressUuid"), CONSTRAINT "PK_951b8f1dfc94ac1d0301a14b7e1" PRIMARY KEY ("uuid"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "cars_fuel_type_enum"`);
