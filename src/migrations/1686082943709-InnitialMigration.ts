...
export class InnitialMigration1686082943709 implements MigrationInterface {
    name = 'InnitialMigration1686082943709'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "adresses" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "cep" character varying(8) NOT NULL, "state" character varying(15) NOT NULL, "city" character varying(50) NOT NULL, "number" character varying(8) NOT NULL, "complement" character varying(20), CONSTRAINT "PK_a2abb7b8a30ae3625f785fe3a48" PRIMARY KEY ("uuid"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."cars_fuel_type_enum" AS ENUM('diesel', 'hybrid', 'electric')`);
        await queryRunner.query(`CREATE TABLE "cars" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(20) NOT NULL, "model" character varying(40) NOT NULL, "year" integer NOT NULL, "fuel_type" "public"."cars_fuel_type_enum" NOT NULL, "mileage" integer NOT NULL, "color" character varying(30) NOT NULL, "is_good_deal" boolean NOT NULL, "value" numeric(10,2) NOT NULL, "description" text NOT NULL, "userUuid" uuid, CONSTRAINT "PK_2931cc94b782957a81bf1018b54" PRIMARY KEY ("uuid"))`);
