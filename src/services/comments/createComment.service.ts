...
import { ICommentCreate, ICommentRepo, ICommentResponse } from "../../interfaces/comments.interface";
...
export const createCommentService = async (
  ...
  carUUID: string
    ...
    const { description, user: { uuid: userId }, uuid: uuid, car: { uuid: carId } } = savedComment;
